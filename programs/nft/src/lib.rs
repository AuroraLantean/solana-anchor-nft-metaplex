...
pub struct CreateNFT<'info> {
  #[account(mut)]
  pub authority: Signer<'info>, //NFT authority can be changed later
  #[account(mut)]
  ...
  /// CHECK:
  pub master_edition_account: UncheckedAccount<'info>, //to make tokens effectively non-fungible by associating them to this master edition account
  #[account(
        mut,
        seeds = [
            b"metadata".as_ref(),
